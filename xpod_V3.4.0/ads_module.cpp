...
int16_t ADS_Module::read_co_aux()
{
...
int16_t ADS_Module::read_co_main()
{
  ads_module_t *sensor = &ads_module[ADS_SENSOR_CO];
...
String ADS_Module::read4print()
{
  ...
  out_str += "FIG2600:" + String(read_raw(ADS_SENSOR_FIG2600)) + ",";
  out_str += "FIG2602:" + String(read_raw(ADS_SENSOR_FIG2602)) + ",";
#if FIGARO3_ENABLED
...
String ADS_Module::read4print_raw()
{
  String out_str = "";
   ...
   out_str += "(" + String(read_raw(ADS_SENSOR_FIG2602)) + "),";
    ...
    out_str += "FIG3_volts:" + String(read_raw(ADS_HEATER_FIG3)) + ",";
    out_str += "(" + String(read_raw(ADS_HEATER_FIG3)) + "),";
  #endif
    ...
    out_str += "FIG4_volts:" + String(read_raw(ADS_HEATER_FIG4)) + ",";
    out_str += "(" + String(read_raw(ADS_HEATER_FIG4)) + "),";
  #endif
