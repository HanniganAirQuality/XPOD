 ...
 * @date    May 22, 2026
 * 
 * @log     Repaired ADDR & CH mismatch 
 *          Updated naming schema for Auxiliary & Worker
 ******************************************************************************/
...
ADS_Module::ADS_Module()
{
  ...
  #if MQ_ENABLED
    ads_module[MQ].addr = 0x4B; // Corrected from 0x48 --> 0x4B 
  ...
  ads_module[AS_WORKER].addr = 0x4A; // Corrected from 0x4B --> 0x4A
  ads_module[AS_WORKER].channel = 0; // Corrected from 1 --> 0 
 ...
 *    @return Reads differential between ADC0 & ADC1 which are Worker AS
 */
/**************************************************************************/
 ...
 *    @return Reads differential between ADC2 & ADC3 which are Auxiliary AS
 */
/**************************************************************************/
